...
// ====================================================================
// LINKER-BRÜCKE: Verhindert "undefined reference" Fehler
// ====================================================================
...
/**
 * Matrix-Worker Task
 * Setzt den Suchbereich direkt im aktuellen Job-Speicher.
 */
void matrix_worker(void *pvParameters) {
    ...
    while (1) {
        ...
        if (GLOBAL_STATE.ASIC_initalized && GLOBAL_STATE.SYSTEM_MODULE.is_connected) {
            ...
            // Direkter Zugriff auf den aktuellen Job, um Linker-Fehler zu vermeiden
